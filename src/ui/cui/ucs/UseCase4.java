...
private String naam;
    ...
    // heb je nodig om te weten of speler meehelpt met gevecht of niet
    public void statusSpelerGevecht(int id, List<Boolean> helptmee){
        UseCase5 uc5 = new UseCase5(this.dc, naam);
        uc5.geefSpelsituatieGevecht(id, helptmee);
    }
}
