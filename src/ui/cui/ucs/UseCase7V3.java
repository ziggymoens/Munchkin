...
class UseCase7V3 {
    ...
    private String naam, stop, choice;
        ...
        try {
            ...
            if (verkoopWeg) {
                ...
                do {
                    ...
                    choice = scan.next();
                    if(choice.equalsIgnoreCase(LanguageResource.getString("usecase7.translationsell")) || choice.equalsIgnoreCase(LanguageResource.getString("usecase7.translationthrow")))
                        match = false;
                }while(match);
